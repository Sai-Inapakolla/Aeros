...
public class UpdateFlightCommandHandler implements ICommandHandler<UpdateFlightCommand, FlightDto> {
  ...
  public UpdateFlightCommandHandler(FlightReadRepository flightRepository) {
  ...
  public FlightDto handle(UpdateFlightCommand command) {
    ...
    flight.update(new FlightId(existingFlight.getFlightId()), new FlightNumber(command.flightNumber()), new AircraftId(command.aircraftId()), new AirportId(command.departureAirportId()), new DepartureDate(command.departureDate()),
