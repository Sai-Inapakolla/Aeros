...
public final class Mappings {
  ...
  public static AircraftDocument toAircraftDocument(Aircraft aircraft) {
    return new AircraftDocument(
      aircraft.getId().getAircraftId(),
      aircraft.getName().getName(),
      aircraft.getModel().getModel(),
      aircraft.getManufacturingYear().getManufacturingYear(),
      aircraft.isDeleted()
    );
  }

  public static AircraftDto toAircraftDto(AircraftDocument aircraftDocument) {
    return new AircraftDto(
      aircraftDocument.getAircraftId(),
      aircraftDocument.getName(),
      aircraftDocument.getModel(),
      aircraftDocument.getManufacturingYear()
    );
  }
